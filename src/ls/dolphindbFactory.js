...
var dolphindb_1 = require("dolphindb"); //导入API
/**
 * 创建并返回一个 DolphinDB 客户端实例
 * @param configOptions 配置选项，包括 URL、端口、用户名、密码等
 * @returns 一个 Promise，解析为 DolphinDB 客户端实例
 */
function createDDBClient(configOptions) {
    return __awaiter(this, void 0, void 0, function () {
        var urladdress, ddb;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    urladdress = "ws://".concat(configOptions.URL, ":").concat(configOptions.port);
                    ddb = new dolphindb_1.DDB(urladdress, { autologin: configOptions.autolog,
                        username: configOptions.username,
                        password: configOptions.password,
                        python: configOptions.py,
                        streaming: configOptions.stream });
                    return [4 /*yield*/, ddb.connect()];
                case 1:
                    _a.sent(); //建立链接
                    return [2 /*return*/, ddb];
            }
